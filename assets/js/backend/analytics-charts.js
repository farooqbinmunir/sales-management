document.addEventListener('DOMContentLoaded', function() {
    // Monthly Sales Chart
    const monthlyCtx = document.getElementById('fbmMonthlySalesChart').getContext('2d');
    ...
    const productCtx = document.getElementById('fbmProductPerformanceChart').getContext('2d');
