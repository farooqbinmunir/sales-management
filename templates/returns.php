<form id="returnForm">
    ...
    <section id="returnForm_body" style="display: none;">
        ...
        <div class="return_form_field_group">
            ...
            <input type="number" name="quantity" id="return_quantity" placeholder="Returned Quantity" min="1" step="1" required />
        ...
        <button type="submit sms_btn">Process Return</button>
    </section>
